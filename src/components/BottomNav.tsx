...
export const BottomNav = () => {
  ...
  // Check localStorage for role when on settings page
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 border-t border-white/20 bg-white/95 backdrop-blur-sm z-50 safe-bottom">
