  ...
  return (
    <div className="min-h-screen w-full gradient-welcome relative overflow-hidden">
      ...
      <div className={`min-h-screen w-full relative z-10 transition-all duration-1000 ease-in-out ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
        ...
        {/* Mobile Layout */}
        <div className="md:hidden h-full flex flex-col items-center justify-center px-4 sm:px-6">
          ...
          <div className="text-center space-y-6 px-2">
            <h1
              className={`text-fluid-4xl font-bold text-gray-800 transition-all duration-700 ease-out ${
            ...
            <p
              className={`text-fluid-lg text-gray-600 transition-all duration-700 ease-out delay-200 ${
            ...
            >
              <div className="space-y-4">
                <button
                  onClick={() => navigate('/login')}
                  className="w-full rounded-full bg-black px-8 py-4 font-semibold text-white text-fluid-lg shadow-lg hover:scale-105 hover:bg-gray-900 transition-all"
                >
                  Sign In
                </button>
                <button
                  onClick={() => navigate('/signup')}
                  className="w-full rounded-full border-2 border-black bg-white px-8 py-4 font-semibold text-black text-fluid-lg shadow-lg hover:scale-105 hover:bg-gray-50 transition-all"
                >
                  Sign Up
                </button>
              </div>
