  ...
  upcomingClasses: [
    {
      ...
      meetingLink: 'https://meet.yadalearn.com/class-1',
      materials: [
        {
          id: 'material-1',
          name: 'Spanish Vocabulary List.pdf',
          type: 'pdf' as const,
          size: '2.4 MB'
        },
        {
      ...
      preparation: [
        {
          id: 'prep-1',
          title: 'Review vocabulary from lesson 5',
          completed: true,
          type: 'reading' as const
        },
        {
          id: 'prep-2',
          title: 'Complete pronunciation exercise',
          completed: false,
          type: 'exercise' as const
        }
      ],
      notes: 'Focus on pronunciation and common phrases for travel situations.'
    },
    {
      id: 'class-2',
      title: 'Advanced Mathematics',
      teacher: 'John Peterson',
      ...
      location: 'online' as const,
      meetingLink: 'https://meet.yadalearn.com/class-2',
      materials: [
        {
          id: 'material-3',
      ...
      notes: 'Bring graphing calculator and prepare questions from last session.'
    }
  ],
  teacherSchedule: [
    {
